...
const About = () => {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-white to-white relative" id='about'>
      {/* Background Image */}
      ...
      <div className="relative container z-10 py-6 px-4 text-center text-gray-800">
        ...
        <p className="text-xl mb-6 mx-25 text-black-200">
            ...
            <div key={card.id} className="w-full sm:w-1/2 md:w-1/3 p-3">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col h-full">
                <div className="p-4 flex-1 flex flex-col">
                  <p className="mb-4 text-gray-600 text-md font-medium flex-1 text-justify">{card.description}</p>
